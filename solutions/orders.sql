...
VALUES ( 012435, 'Product', 12.50, 2 ),
 ( 012435, 'Product', 12.50, 2 ),
 ( 012223, 'Product', 12.50, 2 ),
 ( 012223, 'Product', 12.50, 2 ),
 ( 089876, 'Product', 12.50, 2 );
...
SELECT SUM(product_price * quantity) FROM orders WHERE person_id = 012223;